...
int main() {
	...
	std::vector<std::string> vecTask = { dateRoot + "\\tra", dateRoot + "\\rot", dateRoot + "\\lig_rect", dateRoot + "\\lig_qb", dateRoot + "\\lig_qbc" };
	//std::vector<std::string> vecTask = { dateRoot + "\\lig_qb" };
